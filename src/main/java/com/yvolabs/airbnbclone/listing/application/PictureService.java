...
import static com.yvolabs.airbnbclone.listing.mapper.ListingPictureMapper.INSTANCE;
...
public class PictureService {
    ...
    public List<PictureDTO> saveAll(List<PictureDTO> pictures, Listing listing) {
        Set<ListingPicture> listingPictures = INSTANCE.pictureDTOsToListingPictures(pictures);
        ...
        return INSTANCE.listingPictureToPictureDTO(listingPictures.stream().toList());
    }
}
